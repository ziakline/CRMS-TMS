...
type DashboardContentProps = {
  ...
  latestArSyncText: string;
  latestApSyncText: string;
  selectedYear: number;
};
    ...
    <main className="min-w-0 flex-1 overflow-x-hidden p-6 md:p-10">
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <article className="rounded-xl bg-blue-50 p-6 shadow-sm ring-1 ring-blue-200">
          ...
          <p className="mt-2 text-sm text-blue-700">최근 동기화: {latestArSyncText}</p>
        ...
        <article className="rounded-xl bg-rose-50 p-6 shadow-sm ring-1 ring-rose-200">
          ...
          <p className="mt-2 text-sm text-rose-700">최근 동기화: {latestApSyncText}</p>
